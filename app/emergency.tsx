      ...
      <ScrollView contentContainerStyle={styles.content}>
        <Animated.View style={[styles.alertHeader, { opacity: fadeAnim }]}>
          ...
          <Text style={styles.alertType}>
            {incident?.type.toUpperCase()} DETECTED
          </Text>
        </Animated.View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.aiBox}>
            ...
            <Text style={styles.aiText}>
              {incident
                ? `${incident.severity.toUpperCase()} severity event assigned to ${incident.team}. Follow evacuation and team instructions.`
                : "Follow emergency instructions and avoid active hazard zones."}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.routeDistance}>
            Safe Distance: {EMERGENCY_ROUTE.safeDistance}
          </Text>
...
const styles = StyleSheet.create({
  ...
  cardText: { fontSize: 13, color: "#334155", marginBottom: 6, lineHeight: 22 },
  aiBox: {
  ...
  aiText: { color: "#991b1b", fontSize: 12, lineHeight: 20 },
  ...
  stepNumText: { color: "white", fontWeight: "bold", fontSize: 11 },
  stepText: { flex: 1, fontSize: 13, color: "#334155", lineHeight: 22 },
  mapBtn: {
  ...
  mapBtnText: { color: "#0f172a", fontWeight: "bold", fontSize: 14 },
